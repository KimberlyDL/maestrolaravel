    ...
    public function run(): void
    {
        $permissions = [
            ...
            [
                ...
                'description' => 'Set availability, confirm/decline assignments, request swaps, accept/decline swap requests, check in/out',
                'category' => 'duty'
            ],
            [
                'name' => 'manage_duty_system',
                'display_name' => 'Manage Duty System (Admin)',
                'description' => 'Create/edit/delete schedules, assign officers, approve/reject swaps with reassignment, view statistics and audit logs',
                'category' => 'duty'
            ],
            // Analytics & Reports
            [
